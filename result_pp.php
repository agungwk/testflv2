...
<body  style="background-color: #7798c5;">
	...
	<div class="">
		...
		<ul class="nav nav-tabs resultHead" role="tablist">
			...
			<li role="presentation" style="width: 35%; text-align: center; float:right;">
				<a class="tiketCom" href="#tiketCom" aria-controls="flights" role="tab" data-toggle="tab" style="background-color: #fff !important; color: rgba(255, 255, 255, 0) !important;">
					Tiket
				</a>
			</li>
		</ul>
						...
						<div class="tab-content" style="padding: 10px;">
							<div role="tabpanel" class="tab-pane active" id="Skyscanner">
								...
								<div role="tabpanel" class="tab-pane" id="tiketCom">
										...
										<div class="col-xs-12 no-padding">
											<div class="col-xs-6" style="padding: 2px !important;">
												...
												<div class="no-padding no-margin">
													<?php foreach ($formdata->tiket_departures as $row) { ?>
														<div class="cat_check">
															<div class="col-xs-12 marginB5 no-padding">
																<div id="checkboxes" class="checkboxes checkboxes-d">
																	<input type="checkbox" name="rGroup" class="check_cat check-d" value="result" id="<?php echo $row->departure->id; ?>" check-id="<?php echo $row->departure->id; ?>"/>
																	<div class="check_overlay">
																		<i class="icon-checkmark"></i>
																	</div>
																	<label class="whatever whatever-d" for="r3" check-id="<?php echo $row->departure->id; ?>" choosed="false">
																		...
																		<div style="width:100%; float: left; border-bottom: 1px solid #e0dcdc; padding-bottom: 5px;">
																			...
																			<div class="col-xs-6 stopBox2">
																				<div class="stops">
																					...
																					<div class="leg-stops">
																						<span class="leg-stops-red leg-stops-label"><?php echo $row->departure->transit; ?></span>
																					</div>
																				</div>
																			</div>
																			...
																			<div class="col-xs-3 arrive2">
																				...
																				<span class="stop-station2" data-id="10485"><?php echo substr($row->departure->full_via,6,3); ?></span>
																			</div>
																		</div>

																		<div style="width: 100%; padding-top: 10px; display: inline-block;">
																			<div class="col-xs-6 no-padding price2">Rp.<?php echo number_format(intval($row->total_price),0,',','.') ?>/org</div>
											...
											<div class="col-xs-6" style="padding: 2px !important;">
												...
												<div class="no-padding no-margin">
													...
													<?php foreach ($formdata->tiket_returns as $row) { ?>
														<div class="cat_check">
															<div class="col-xs-12 marginB5 no-padding">
																<div id="checkboxes" class="checkboxes-r">
																	<input type="checkbox" name="rGroup" class="check_cat check-r" value="result" id="<?php echo $row->return->id; ?>" check-id="<?php echo $row->return->id; ?>"/>
																	<div class="check_overlay">
																		<i class="icon-checkmark"></i>
																	</div>
																	<label class="whatever whatever-r" for="r3" check-id="<?php echo $row->return->id; ?>" choosed="false">
																		...
																		<div style="width:100%; float: left; border-bottom: 1px solid #e0dcdc; padding-bottom: 5px;">
																			...
																			<div class="col-xs-6 stopBox2">
																				<div class="stops">
																					...
																					<div class="leg-stops">
																						<span class="leg-stops-red leg-stops-label"><?php echo $row->return->transit; ?></span>
																					</div>
																				</div>
																			</div>
									...
									<div id="btnPesan" class="btnDock" style="display:none;">PESAN</div>
								</div>
							</div> <!-- Tab content -->
	...
	$(document).ready(function($) {
		...
		// $("#hide").click(function(){
		// 	$("#btnPesan").hide();
		// 	console.log('#btnPesan hide');
		// });
		// $("#show").click(function(){
		// 	$("#btnPesan").show();
		// 	console.log('#btnPesan show');
		// });
		$("#btnPesan").click(function(){
			var results = <?php echo json_encode($formdata); ?>;
			var departure_id, return_id = '';

			$( ".whatever-d" ).each(function(e) {
				if ($(this).attr('choosed')=='true') {
					departure_id = $(this).attr('check-id');
				}
			});
			$( ".whatever-r" ).each(function(e) {
				if ($(this).attr('choosed')=='true') {
					return_id = $(this).attr('check-id');
				}
			});

			var dept, ret = {};
			$.each(results.tiket_departures, function(k, v) {
				if (v.departure.id == departure_id) {
					dept = v;
			...
			var post_data = {
				"result" : {'departure' : dept, 'return' : ret},

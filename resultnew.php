				...
				<div class="tabulation animate-box">
					...
					<div class="tab-content" style="padding: 10px;">
						<div role="tabpanel" class="tab-pane active" id="Skyscanner">
							<div class="row">
								<?php
									foreach ($formdata->results as $row) {
											...
											<div class="listBox">
												...
												<div style="width:calc(100% - 70px); float: left;">
													...
													<div class="col-xs-6 stopBox">
														<div class="stops">
															<?php
																$fl_duration = $row->departure->duration;
																$fl_hour = 0;
																$fl_minute = 0;

																$fl_hour = floor($fl_duration / 60);
																$fl_minute = $fl_duration - ($fl_hour * 60);
															?>
															<span class="duration"><?php echo $fl_hour . ' j ' . $fl_minute . ' m'; ?></span>
															...
															<div class="leg-stops">
																<span class="leg-stops-red leg-stops-label"><?php echo count($row->departure->transit) == 0 ? "Langsung" : count($row->departure->transit) . ' Stop'; ?></span>
															</div>
														</div>
													</div>
								...
								<div class="row">
									...
									<div class="col-xs-12 whiteBox">
										...
										<div class="col-xxs-12 col-xs-4 padOrder">
											<div class="col-xs-7 col-md-12 col-sm-12 no-padding price">Rp.<?php echo number_format(intval($row->total_price),0,',','.') ?></div>
											<div class="col-xs-5 col-md-12 col-sm-12 no-padding">
												<input type="button" class="btn btn-primary btn-block btnResultOrder submit-tiket" tiket-id="<?php echo $row->departure->id; ?>" value="PESAN">
											</div>
										</div>
									</div>
									<?php } ?>

...
if (isset($_GET['date'])) {
	$s_date = date("Y-m-d", strtotime($_GET['date']));
}
												...
												<div class="col-xs-6 mt alternate">
													<div class="input-field">
														...
														<div class="input-group">
															<input type="text" name="departure_date" data-date-format="yyyy-mm-dd"  class="form-control custom-date-picker"  id="date-start" placeholder="mm/dd/yyyy"/ value="<?php echo (strcmp($s_date, '')==0) ? date('Y-m-d', strtotime('+1 days')) : $s_date; ?>">
											...
											<div class="col-xxs-12 mt alternate no-padding">
												...
												<div class="col-xs-6 mt alternate">
													<div class="input-field">
														<label for="date-start" class="lableFont">BERANGKAT:</label>
														<div class="input-group">
															<input type="text" class="form-control custom-date-picker"  name="departure_date_pp" id="date-start" data-date-format="yyyy-mm-dd" placeholder="mm/dd/yyyy" value="<?php echo (strcmp($s_date, '')==0) ? date('Y-m-d', strtotime('+1 days')) : $s_date; ?>"/>
															<div class="input-group-addon">
																<i class="icon-calendar"></i>
															</div>
														</div>
												...
												<div class="col-xs-6 mt alternate">
													<div class="input-field">
														...
														<div class="input-group">
															<input type="text" class="form-control custom-date-picker" name="return_date" id="date-end" data-date-format="yyyy-mm-dd" placeholder="mm/dd/yyyy"/ value="<?php echo (strcmp($s_date, '')==0) ? date('Y-m-d', strtotime('+3 days')) : $s_date; ?>">
															<div class="input-group-addon">
																<i class="icon-calendar"></i>
															</div>
														</div>
										...
										<div class="row mt no-margin">
											...
											<div class="col-xs-12 alternate">
												...
												<div class="row">
													...
													<div class="col-xs-4 alternate">
														<div class="input-group">
															<select class="cs-select cs-skin-border" name="children" id="children_pp">
																<option value="0" disabled selected>0</option>
																<option value="1">1</option>
																<option value="2">2</option>
																<option value="3">3</option>
...
<script>
$(document).ready(function(){
	$('.custom-date-picker').on('changeDate', function(ev){
	...
	$('#form-fl').submit(function(e) {
		...
		"infant" : $("#children").find(":selected").val(),
...
$(document).ready(function(){
	...
	$('#form-pp').submit(function(e) {
		...
		"infant" : $("#children_pp").find(":selected").val(),
